...
docker run --rm --name certbot -v '/etc/letsencrypt:/etc/letsencrypt' -v '/var/lib/letsencrypt:/var/lib/letsencrypt' -v '/home/opc/cloudflare.ini:/root/cloudflare.ini' certbot/dns-cloudflare certonly -d *.montessoris.net -d montessoris.net --dns-cloudflare --dns-cloudflare-credentials /root/cloudflare.ini --email ryan-dev@kakao.com --agree-tos --no-eff-email --force-renewal --dns-cloudflare-propagation-seconds 15
docker run --rm --name certbot -v '/etc/letsencrypt:/etc/letsencrypt' -v '/var/lib/letsencrypt:/var/lib/letsencrypt' -v '/home/opc/cloudflare.ini:/root/cloudflare.ini' certbot/dns-cloudflare certonly -d *.mamamonte.kr -d mamamonte.kr --dns-cloudflare --dns-cloudflare-credentials /root/cloudflare.ini --email ryan-dev@kakao.com --agree-tos --no-eff-email --force-renewal --dns-cloudflare-propagation-seconds 15
